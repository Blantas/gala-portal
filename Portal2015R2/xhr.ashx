...
Object.extend(XHR_class.prototype, Object.extend(new AjaxPro.AjaxClass(), {
	...
	GeneralSearch: function(name) {
		return this.invoke("GeneralSearch", {"name":name}, this.GeneralSearch.getArguments().slice(1));
	},
	...
	GetMyFavouriteTvRecords: function(startDate) {
		return this.invoke("GetMyFavouriteTvRecords", {"startDate":startDate}, this.GetMyFavouriteTvRecords.getArguments().slice(1));
	},
	GetMyFavCahnnels: function() {
		return this.invoke("GetMyFavCahnnels", {}, this.GetMyFavCahnnels.getArguments().slice(0));
	},
	GetMyFavKaraokeSongs: function() {
		return this.invoke("GetMyFavKaraokeSongs", {}, this.GetMyFavKaraokeSongs.getArguments().slice(0));
	},
	GetMyFavRadioStations: function() {
		return this.invoke("GetMyFavRadioStations", {}, this.GetMyFavRadioStations.getArguments().slice(0));
	},
	GetMyFavGalaCodes: function() {
		return this.invoke("GetMyFavGalaCodes", {}, this.GetMyFavGalaCodes.getArguments().slice(0));
	},
	...
	GetCurrentJsVerNr: function() {
		return this.invoke("GetCurrentJsVerNr", {}, this.GetCurrentJsVerNr.getArguments().slice(0));
	},
	...
	SetRadioBackground: function(path) {
		return this.invoke("SetRadioBackground", {"path":path}, this.SetRadioBackground.getArguments().slice(1));
	},
	...
	SetRadioBackgroundCollection: function(folder, path) {
		return this.invoke("SetRadioBackgroundCollection", {"folder":folder, "path":path}, this.SetRadioBackgroundCollection.getArguments().slice(2));
	},
	SetRadioBackgroundFromSocial: function(socialNetworkAndUrl) {
		return this.invoke("SetRadioBackgroundFromSocial", {"socialNetworkAndUrl":socialNetworkAndUrl}, this.SetRadioBackgroundFromSocial.getArguments().slice(1));
	},
	...
	CheckCallStatus: function(sId) {
		return this.invoke("CheckCallStatus", {"sId":sId}, this.CheckCallStatus.getArguments().slice(1));
	},
	TestCall: function() {
		return this.invoke("TestCall", {}, this.TestCall.getArguments().slice(0));
	},
	...
	GalaCodeLogin: function(userName, pwd) {
		return this.invoke("GalaCodeLogin", {"userName":userName, "pwd":pwd}, this.GalaCodeLogin.getArguments().slice(2));
	},
	...
	GetProgramesBySeriesIdAll: function(seriesId) {
		return this.invoke("GetProgramesBySeriesIdAll", {"seriesId":seriesId}, this.GetProgramesBySeriesIdAll.getArguments().slice(1));
	},
	GetProgramesBySeriesIdWithPaging: function(seriesId, progId, direction, recordLimit, favOnly) {
		return this.invoke("GetProgramesBySeriesIdWithPaging", {"seriesId":seriesId, "progId":progId, "direction":direction, "recordLimit":recordLimit, "favOnly":favOnly}, this.GetProgramesBySeriesIdWithPaging.getArguments().slice(5));
	},
	...
	GetSmartEpgPrograms: function(radioMode, chanId, catId, genreId, favOnly, date, currentChanId, progId, progIdx, dir, limit, order) {
		return this.invoke("GetSmartEpgPrograms", {"radioMode":radioMode, "chanId":chanId, "catId":catId, "genreId":genreId, "favOnly":favOnly, "date":date, "currentChanId":currentChanId, "progId":progId, "progIdx":progIdx, "dir":dir, "limit":limit, "order":order}, this.GetSmartEpgPrograms.getArguments().slice(12));
	},
	...
	GetCurrentProgrammeForSmart: function(chanId) {
		return this.invoke("GetCurrentProgrammeForSmart", {"chanId":chanId}, this.GetCurrentProgrammeForSmart.getArguments().slice(1));
	},
	...
	GetCurrentProgrammeForTvOSD: function(chanId, client_id, voting_enabled) {
		return this.invoke("GetCurrentProgrammeForTvOSD", {"chanId":chanId, "client_id":client_id, "voting_enabled":voting_enabled}, this.GetCurrentProgrammeForTvOSD.getArguments().slice(3));
	},
	GetCurrentProgrammesForTvOSDv2: function(chanIds, client_id, voting_enabled) {
		return this.invoke("GetCurrentProgrammesForTvOSDv2", {"chanIds":chanIds, "client_id":client_id, "voting_enabled":voting_enabled}, this.GetCurrentProgrammesForTvOSDv2.getArguments().slice(3));
	},
	GetCurrentProgrammesForTvOSD: function(chanIds, client_id, voting_enabled) {
		return this.invoke("GetCurrentProgrammesForTvOSD", {"chanIds":chanIds, "client_id":client_id, "voting_enabled":voting_enabled}, this.GetCurrentProgrammesForTvOSD.getArguments().slice(3));
	},
	...
	ReportYtvUssageWithTimeout: function(ytvProgTitle, prog_id, chan_id, encoder_name, md_chan_id, tv_id) {
		return this.invoke("ReportYtvUssageWithTimeout", {"ytvProgTitle":ytvProgTitle, "prog_id":prog_id, "chan_id":chan_id, "encoder_name":encoder_name, "md_chan_id":md_chan_id, "tv_id":tv_id}, this.ReportYtvUssageWithTimeout.getArguments().slice(6));
	},
	orderrYTVCatAsset: function(assetId, ytvProgTitle, chanId, prog_id, encoderName) {
		return this.invoke("orderrYTVCatAsset", {"assetId":assetId, "ytvProgTitle":ytvProgTitle, "chanId":chanId, "prog_id":prog_id, "encoderName":encoderName}, this.orderrYTVCatAsset.getArguments().slice(5));
	},
	orderrYTVAsset: function(assetId, ytvProgTitle, chanId, prog_id, encoderName) {
		return this.invoke("orderrYTVAsset", {"assetId":assetId, "ytvProgTitle":ytvProgTitle, "chanId":chanId, "prog_id":prog_id, "encoderName":encoderName}, this.orderrYTVAsset.getArguments().slice(5));
	},
	...
	GetRadioSettings: function() {
		return this.invoke("GetRadioSettings", {}, this.GetRadioSettings.getArguments().slice(0));
	},
	...
	GetAssetForDetails: function(assetId) {
		return this.invoke("GetAssetForDetails", {"assetId":assetId}, this.GetAssetForDetails.getArguments().slice(1));
	},
	GetSeasonEpisodes: function(assetId) {
		return this.invoke("GetSeasonEpisodes", {"assetId":assetId}, this.GetSeasonEpisodes.getArguments().slice(1));
	},
	GetAssetOrSeriesForDetails: function(assetId) {
		return this.invoke("GetAssetOrSeriesForDetails", {"assetId":assetId}, this.GetAssetOrSeriesForDetails.getArguments().slice(1));
	},
	...
	GetMyFavVODAssets: function() {
		return this.invoke("GetMyFavVODAssets", {}, this.GetMyFavVODAssets.getArguments().slice(0));
	},
	...
	url: '/Gala/Portal2015R2/ajaxpro/xhr.ashx'
}));
XHR = new XHR_class();
