...
Object.extend(XHR_class.prototype, Object.extend(new AjaxPro.AjaxClass(), {
	...
	RegisterSwimlaneItemInvoked: function(json) {
		return this.invoke("RegisterSwimlaneItemInvoked", {"json":json}, this.RegisterSwimlaneItemInvoked.getArguments().slice(1));
	},
	RegisterSubscriptionStatistics: function(json) {
		return this.invoke("RegisterSubscriptionStatistics", {"json":json}, this.RegisterSubscriptionStatistics.getArguments().slice(1));
	},
	...
	SubscribePackage: function(pkgid, navigationPath) {
		return this.invoke("SubscribePackage", {"pkgid":pkgid, "navigationPath":navigationPath}, this.SubscribePackage.getArguments().slice(2));
	},
	...
	SetAdvParametersEnabled: function(rank, vote, adv, menu, info, vodSort, zeroChannelDisabled, adultRecsPinRequestType, personalFavsForStb, change, landingScreen) {
		return this.invoke("SetAdvParametersEnabled", {"rank":rank, "vote":vote, "adv":adv, "menu":menu, "info":info, "vodSort":vodSort, "zeroChannelDisabled":zeroChannelDisabled, "adultRecsPinRequestType":adultRecsPinRequestType, "personalFavsForStb":personalFavsForStb, "change":change, "landingScreen":landingScreen}, this.SetAdvParametersEnabled.getArguments().slice(11));
	},
	...
	SubscribeGames: function(navigationPath) {
		return this.invoke("SubscribeGames", {"navigationPath":navigationPath}, this.SubscribeGames.getArguments().slice(1));
	},
	...
	url: '/2019R2/Portal/ajaxpro/XHR,TeliaTVServices.ashx'
}));
XHR = new XHR_class();
